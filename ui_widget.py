...
class Ui_Widget(object):
    def setupUi(self, Widget):
        ...
        self.gridLayout.addWidget(self.button_3, 0, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.button_5, 0, 2, 1, 2)
        ...
        self.gridLayout.addWidget(self.button_6, 1, 2, 1, 2)
        ...
        self.gridLayout.addWidget(self.button_8, 2, 1, 1, 2)
    ...
    def retranslateUi(self, Widget):
        ...
        self.button_2.setText(QCoreApplication.translate("Widget", u"Button 4", None))
        self.button_7.setText(QCoreApplication.translate("Widget", u"Button 7", None))
        self.button_3.setText(QCoreApplication.translate("Widget", u"Button 2", None))
        self.button_4.setText(QCoreApplication.translate("Widget", u"Button 5", None))
        self.button_1.setText(QCoreApplication.translate("Widget", u"Button 1", None))
        self.button_5.setText(QCoreApplication.translate("Widget", u"Button 3", None))
        self.button_9.setText(QCoreApplication.translate("Widget", u"Button 9", None))
        self.button_6.setText(QCoreApplication.translate("Widget", u"Button 6", None))
        self.button_8.setText(QCoreApplication.translate("Widget", u"Button 8", None))
    # retranslateUi
