...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon3 = QIcon()
        icon3.addFile(u":/images/undoIcon.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionUndo.setIcon(icon3)
        self.actionRedo = QAction(MainWindow)
        self.actionRedo.setObjectName(u"actionRedo")
        icon4 = QIcon()
        icon4.addFile(u":/images/redoIcon.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon5 = QIcon()
        icon5.addFile(u":/images/pasteIcon.png", QSize(), QIcon.Normal, QIcon.Off)
