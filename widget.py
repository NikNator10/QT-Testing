...
class Widget(QWidget, Ui_Widget):
    ...
    def button_7_clicked(self):
        color = QColorDialog.getColor(self.color_list[6], self, "Choose a background color")
        if color.isValid():
    ...
    def button_8_clicked(self):
        color = QColorDialog.getColor(self.color_list[7], self, "Choose a background color")
        if color.isValid():
    ...
    def button_9_clicked(self):
        color = QColorDialog.getColor(self.color_list[8], self, "Choose a background color")
        if color.isValid():
    ...
    def save_color(self, key, color):
        ...
        settings = QSettings("YourCompanyName", "QSettings-Demo")
